...
I want to develop an app that allows a person—without coding—to guide AI in delivering working, tested software. Phase 1 will be a web app. The primary platform is a single chat window where the full AI project team—the Project Manager, Architect, Developer, and Tester—works with the client in real time. A hidden persona, the Scribe, will keep meeting notes, sign-offs, and other records, and can also act as the AI’s memory.
...
Vision Meeting 
Develop the Vision Statement that will drive the app

Backlog Refinement (Grooming) Meeting
	•	Purpose: Clarify, split, and prioritize backlog items before sprint planning.
	•	Helps catch ambiguity early and keeps sprint planning focused.
